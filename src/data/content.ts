...
export const siteContent = {
  ...
  results: {
    lark: {
      title: 'Жаворонок',
      description: 'Ты из тех редких птиц, которые способны не только проснуться к 8 утра, но и добровольно куда-то к этому времени прилететь! А ещё успеваешь прожить полдня до того, как остальные выпьют свою первую чашку кофе.',
      defaultRoute: 'lark',
      // Строка под общим блоком про прогулку: подсказка от птицы, но решает гость.
      choiceLine: 'Наверняка тебе такое придётся по душе, но финальное решение всё равно за тобой!',
    },
    pigeon: {
      title: 'Голубь',
      description: 'Ты — городская птица широкого профиля. Можешь оказаться на месте в удивительно ранний час, но только если обстоятельства достаточно убедительны. В тебе мирно уживаются желание ничего не пропустить и талант появляться именно тогда, когда начинается самое интересное.',
      defaultRoute: 'pigeon',
      choiceLine: 'Можешь присоединиться к жаворонкам или прилететь позже с совами. Выбор за тобой!',
    },
    owl: {
      title: 'Сова',
      description: 'Некоторые птицы не торопятся появляться перед публикой — и правильно делают. Ты предпочитаешь не спорить со своими внутренними часами и прилетаешь тогда, когда тебе действительно удобно.',
      defaultRoute: 'owl',
      choiceLine: 'Ты можешь спокойно пропустить прогулку и присоединиться к стае позже. Никакой погони за жаворонками!',
    },
  } satisfies Record<BirdType, { title: string; description: string; defaultRoute: Flock; choiceLine: string }>,
  // Общий блок для всех птиц: единственное, к чему нужно прийти вовремя.
  walk: {
    title: '29 августа планируется прогулка с *Ричардом*, настоящим орнитологом!',
    whereLabel: 'Где',
    where: 'Кронштадт',
    whenLabel: 'Когда',
    when: '8:00',
  ...
  dayPlan: [
    {
      ...
      text: 'Встречаемся на автобусной остановке «Караул» в Кронштадте. Прогулка займёт 3–4 часа.',
      links: [
        {
    ...
    },
    {
      ...
      text: 'Если погода позволяет, отдыхаем и катаемся на сапах. Закуски для общего стола только приветствуются. Пляж на территории заказника «Западный Котлин», поэтому мангалы нельзя, но если очень аккуратно, то можно.',
    },
    {
      title: 'Новоселье',
    ...
    },
    {
      ...
      text: 'Либо остаёмся в квартире в Кронштадте, либо возвращаемся в Питер и продолжаем там.',
      links: [
        {
          label: 'Королёва, 64к1',
  ...
  weatherScenarios: [
    {
      ...
      status: 'ready',
      items: [
        'Всё идёт по плану дня — ничего не меняется',
      ],
      link: { label: 'Посмотреть план дня', href: '#day-plan' },
    },
    {
      id: 'rainy-morning',
      icon: 'storm',
      ...
      status: 'ready',
      items: [
        'Прогулка с орнитологом отменяется и, скорее всего, переносится на следующий день',
        'Дальше смотрим по ситуации и импровизируем',
        'Все перелёты — в Диспетчерской в Телеграме',
      ],
    },
  ],
  walkClothing: {
    title: 'Как одеться на прогулку',
    text: 'Утром наверняка будет прохладно, ветрено и дождливо. Лучше выбрать непродуваемую и непромокаемую верхнюю одежду, а главное — обувь, в которой ноги останутся сухими. Дождевик и запасные носки могут пригодиться.',
  },
  dressCode: {
    title: 'Оперение',
    text: 'Будет очень круто, если ты поддержишь птичью тематику: добавишь перья, аксессуар или соберёшь целый образ!',
  ...
  confirmation: {
    ...
    lead: 'Всегда можно передумать!',
    options: [
      { value: 'walk', label: 'Прилечу на прогулку к\u00a008:00', hint: 'Ранний вылет' },
    ...
    messagePlaceholder: 'Вдруг тебе есть, что сказать!',
  ...
  ui: {
    ...
    name: {
      ...
      error: 'Впиши имя буквами — иначе я не пойму, кто прилетел',
    },
    result: {
      eyebrow: '{name}, наблюдение завершено',
      title: 'Ты — {bird}',
      keptOriginal: 'Исходный результат теста сохранён.',
      // Зовущая строка перед лётным листом и подпись у падающего пера.
      cta: 'Выбрать время прилёта',
    },
    // Маячок внизу экрана, пока ответ не отправлен.
    beacon: 'Не забудь отметиться!',
    dayPlan: {
    ...
    // Экран после отправки лётного листа. Три состояния по выбранному варианту.
    saved: {
      inFlockTitle: 'Отлично, ты в стае!',
      walk: 'Ждём тебя 29 августа в 08:00 на прогулке. Дальше ты найдёшь подробный план дня, явки-пароли, а также как поддержать тему праздника.',
      later: 'Приезжай когда удобно — все передвижения будут в Диспетчерской в Телеграме. Дальше ты найдёшь подробный план дня, явки-пароли, а также как поддержать тему праздника.',
      declinedTitle: 'Жаль, что ты не придёшь(',
      declined: 'Но сайт всё равно полистай — вдруг передумаешь. Мы будем тебя ждать!',
      change: 'Изменить ответ',
      hint: 'Передумаешь — просто отметь другую строку.',
      pendingTitle: 'Новый ответ пока не записан',
      pending: 'Нажми «Изменить ответ», чтобы сохранить его.',
    },
    notices: {
      walkConfirmed: 'Ура, летим вместе в 08:00!',
      walkSkipped: 'Отлично, ждём тебя позже!',
      declined: 'Жаль! Но мы всё равно тебя ждём',
      restarted: 'Летим заново! Прошлый результат сотрётся',
    },
    save: {
      sending: 'Отправляем в стаю…',
      error: 'Ответ сохранился у тебя, но до нас пока не долетел',
