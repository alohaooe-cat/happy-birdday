...
export const siteContent = {
  ...
  questions: [
    ...
    {
      id: 'three-forty',
      prompt: 'Незнакомый человек подсел к тебе и сказал: «Я знаю, чем ты занимаешься в 03:40». Твоя первая мысль:',
      answers: [
        { id: 'which-day', label: '«Он имеет в виду вчера или две недели назад?»', score: 0 },
        { id: 'asleep', label: '«Он адекватный? Я в это время сплю»', score: 1 },
        { id: 'psychics', label: '«Как он узнал про “Битву экстрасенсов”?»', score: -1 },
      ],
    },
    {
      id: 'bird-outfit',
