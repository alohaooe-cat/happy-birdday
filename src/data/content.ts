...
export const siteContent = {
  ...
  routes: {
    lark: {
      ...
      items: [
        ...
        'Три-четыре часа блужданий и наблюдений за птицами с *Ричардом*',
  ...
  dayPlan: [
    ...
    },
    {
      ...
      address: 'Улица Зосимова, 4 · подъезд 7 · этаж 3 · квартира 220',
      links: [
        {
          label: 'Зосимова, 4',
    ...
    },
    {
      ...
      address: 'Проспект Королёва, 64к1 · подъезд 1 · этаж 10 · квартира 33',
      links: [
        {
          label: 'Королёва, 64к1',
  ...
  weatherScenarios: [
    {
      ...
      status: 'ready',
      items: [
        'В 08:00 идём на прогулку с орнитологом на 3–4 часа',
        'Если погода позволяет, после прогулки едем на пляж: пикник, сапы и воздушный змей',
        'Едем на Зосимова, 4: устраиваем новоселье и наряжаемся',
        'Гуляем по Кронштадту',
        'Продолжаем вечеринку в Кронштадте или едем на проспект Королёва, 64к1',
      ],
    },
    {
      id: 'rainy-morning',
